...
export const listPrItemTableData = [
		{
			item_no: '10001',
			unit: 'Pack',
		...
		},
		{
			item_no: '10002',
			unit: 'Pack',
			item_description: 'Colored Paper',
			quantity: '4',
			unit_cost: '120.00',
		},
	]
...
export const listOfDepartments = [
		...
		{ label: 'City Engineer\'s Office (CEO)', value: 'City Engineer\'s Office (CEO)' },
		{ label: 'City Agriculture Services Office (CASO)', value: 'City Agriculture Services Office (CASO)' },
		{ label: 'City Environment and Natural Resources Office (CENRO)', value: 'City Environment and Natural Resources Office (CENRO)' },
		{ label: 'City Veterinary Office (CVO)', value: 'City Veterinary Office (CVO)' },
		{ label: 'City Disaster and Risk Reduction Management Office (CDRRMO)', value: 'City Disaster and Risk Reduction Management Office (CDRRMO)' },
		{ label: 'Permits and Licensing (PL)', value: 'Permits and Licensing (PL)' },
		{ label: 'Public Information (PI)', value: 'Public Information (PI)' },
